 ...
 * @author Sourabh
 * 
 *	This is sort of an utility class helps to determine number 
 *  of letters in given String. Furthermore, It also helps in
 *  calculating how many alphabets in the decrypted text are 
 *  not in the frequency range of English language.
 */
public class English {

	//instance variable
	private final static int max = Rotor.max;
	private static double[] engLetterFreq = { 8.1, 1.6, 3.2, 3.6, 
			12.3, 2.3, 1.6, 5.1, 7.2, 0.1, 0.5, 4.0, 2.2, 7.2,7.9, 
			2.3, 0.2, 6.0, 6.6, 9.6, 3.1, 0.9, 2.0, 0.2, 1.9, 0.1 };
	private static int[] engLetterDeviation = { 10, 50, 30, 30, 10, 30, 
			50, 20, 15, 100, 80, 30, 30, 20, 20, 30, 100,30, 20, 15, 30, 
			60, 40, 100, 40, 100 };
	...
	/**
	 * This calculates the percentage of occurrence 
	 ...
	 * @return
	 * 
	 * 	This method check whether given alphabet
	 *  is with in the range of Frequency count
	 */
