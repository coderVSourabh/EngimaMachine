 ...
 * @author Sourabh
 * 
 * It’s the starting point of execution for our project. 
 * It reads file and look for rotor settings to decrypt the text
 */
			...
			for (int j = 0; j < max; j++) {
				for (int k = 0; k < max; k++) {
					...
					if (errorCount <= EnigmaUtil.ERRORSALLOWED) {
						System.out.println("Rotor settings are : R1=" + k + ",R2=" 
								+ j + ",R3=" + i);
						System.out.println("Current Error count :" + errorCount 
								+ ", with Multiplier : " + EnigmaUtil.MULTIPLIER);
